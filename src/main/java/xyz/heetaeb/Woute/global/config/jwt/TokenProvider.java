...
import xyz.heetaeb.Woute.domain.user.entity.CustomUserDetails;
...
public class TokenProvider {
    ...
    public TokenDto generateTokenDto(Authentication authentication) {
        ...
        System.out.println("뭐가 들어있냐" + userEmail);
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        String userEmail = claims.get("email", String.class); // 이메일 정보 가져오기
        System.out.println("getAuthen :"+userEmail);
